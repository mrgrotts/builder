...
import { updateObject, validateFields } from '../../../utils/utils';
...
class Customer extends Component {
  ...
  updateField = (event, field) => {
    const updatedField = updateObject(this.state.form[field], {
      value: event.target.value,
      valid: validateFields(event.target.value, this.state.validation),
      touched: true
    });
